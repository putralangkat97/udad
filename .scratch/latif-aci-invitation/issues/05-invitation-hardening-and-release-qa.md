...
- [ ] User-provided guest names and messages cannot inject executable markup into public or moderation views.
- [ ] Public RSVP and wish submissions are throttled and return appropriate errors when limits or validation rules are exceeded.
- [ ] The existing Laravel feature tests, focused invitation tests, TypeScript checks, and project quality checks pass.
